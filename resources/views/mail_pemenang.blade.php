...
<body>
	...
	<p><span style="color: #333333;">Dengan ini PT.PAL Indonesia mengumumkan bahwasanya Anda memenangkan lelang atas proyek <strong>{{$pengumuman->kode}}</strong> dengan harga penawaran <strong style="color:red;">{{number_format($pemenang->total_auction,0,",",".")}}</strong></span>
	</p>
	<p><span style="color: #333333;">Silahkan Download kontrak anda dengan klik link berikut ini</span><br>
	<a href="{{env('SERVER').'/'.
