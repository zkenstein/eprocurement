                                    ...
                                    CanResetPasswordContract
{
     ...
     * @var array
     */
    protected $fillable = ['kode', 'nama', 'email','password','telp','bidang_usaha','aktif','kadaluarsa','session_id','role','cluster','departemen_id','alamat','fax','pimpinan','cp','telp_cp','email_cp','klas_usaha','klas','is_kondite'];
    ...
    public function listBarangEksternalAuction()
    {
