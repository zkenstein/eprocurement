...
class Pengumuman extends Model
{
    ...
    protected $fillable = ['kode','deskripsi','batas_awal_waktu_penawaran','batas_akhir_waktu_penawaran','validitas_harga','waktu_pengiriman','harga_netto','mata_uang','max_register','pic','file_excel','start_auction','durasi','syarat_dan_ketentuan'];
